xtabloc <- ("~/Documents/Research/Work/Story/FiveMovieTest/Movies/TheMatrix/xtab.txt");
caloc <- ("~/Documents/Research/Work/Story/FiveMovieTest/ca.r");
clickloc <- ("~/Documents/Research/Work/Story/FiveMovieTest/clink_hcluswtd.r");
pdfloc <- ("~/Documents/Research/Work/Story/FiveMovieTest/RPlots/Matrix.pdf");
tt <- ("The Matrix");
...
selnames <- c("neo", "morpheus", "trinity", "smith", "tank", "cypher", "oracle", "matrix", "anderson", "dozer", "cops");
...
plot(ytaby$cproj[1:217,1],ytaby$cproj[1:217,2],type="n",xlab="Factor 1",ylab="Factor 2");
...
text(ytaby$cproj[1:217,1],ytaby$cproj[1:217,2],rep(".",217));
...
#Dimensions 1,3 
plot(ytaby$cproj[1:217,1],ytaby$cproj[1:217,3],type="n",xlab="Factor 1",ylab="Factor 3");
title(tt, sub = "Scatter Plot", cex.main = 3, col.main = "blue", cex.sub = 2, col.sub = "sky blue");
#text(ytaby$rproj[,1],ytaby$rproj[,2],selnames,col="red");
text(ytaby$rproj[selection,1],ytaby$rproj[selection,3],selnames,col="red");
text(ytaby$cproj[1:217,1],ytaby$cproj[1:217,3],rep(".",217));

#Dimensions 2,3 
plot(ytaby$cproj[1:217,2],ytaby$cproj[1:217,3],type="n",xlab="Factor 2",ylab="Factor 3");
title(tt, sub = "Scatter Plot", cex.main = 3, col.main = "blue", cex.sub = 2, col.sub = "sky blue");
#text(ytaby$rproj[,1],ytaby$rproj[,2],selnames,col="red");
text(ytaby$rproj[selection,2],ytaby$rproj[selection,3],selnames,col="red");
text(ytaby$cproj[1:217,2],ytaby$cproj[1:217,3],rep(".",217));
#dev.off();
...
#text3d(ytaby$cproj[,2],ytaby$cproj[,3],ytaby$cproj[,4],1:217);

x1 <- ytaby$cproj[1:217,1]
plot(x1,type="l")
...
peaks2 = c(12,16,25,28,36,40,48,52,58,63,79,86,93,98,109,114,123,125,128,134,141,144,150,157,161,167,170,175,179,191,195,200,208)
text(peaks2,x2f[peaks2],peaks2);

x3 <- ytaby$cproj[1:217,3]
plot(x3,type="l")
...
title("The Matrix Self-Similarity using dimensions 1:3")
...
image(1:217,1:217,Smat,xlab = "Scene number", ylab = "Scene number")
text(bs2page/110*217,bs2page/110*217,bs2sect)
title("The Matrix Self-Similarity using dimensions 1:2")
