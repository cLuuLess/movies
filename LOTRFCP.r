xtabloc <- ("~/Documents/Research/Movies/LOTRF/xtab.txt");
caloc <- ("~/Documents/Research/ca.r");
clickloc <- ("~/Documents/Research/clink_hcluswtd.r");
pdfloc <- ("~/Documents/Research/RPlots/LOTRF_scatter.pdf");
...
plot3d(ytaby$rproj[1,],ytaby$rproj[2,],ytaby$rproj[3,],type="p");
